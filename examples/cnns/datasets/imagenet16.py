...
FilePath: /zero-cost-proxies/Unknown/datasets/imagenet16.py
'''
##################################################
...
if __name__ == '__main__':
  train = ImageNet16('/home/Unknown/GitHub/zero-cost-test/_dataset/ImageNet16-120', True , None) 
  valid = ImageNet16('/home/Unknown/GitHub/zero-cost-test/_dataset/ImageNet16-120', False, None) 

  print ( len(train) )
  print ( len(valid) )
  image, label = train[111]
  trainX = ImageNet16('/home/Unknown/GitHub/zero-cost-test/_dataset/ImageNet16-120', True , None, 200)
  validX = ImageNet16('/home/Unknown/GitHub/zero-cost-test/_dataset/ImageNet16-120', False , None, 200)
  print ( len(trainX) )
  print ( len(validX) )
